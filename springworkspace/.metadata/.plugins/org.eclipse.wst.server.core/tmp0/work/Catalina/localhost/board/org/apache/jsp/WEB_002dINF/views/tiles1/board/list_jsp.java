 ...
 * Generated at: 2020-07-27 05:38:23 UTC
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String ctxPath = request.getContextPath(); 
      ...
      out.write("\t\t");
      out.write("\r\n");
      out.write("\t\t$(\"#displayList\").hide(); // 관련 검색어 창 뜨는거 일단 숨기기\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#searchWord\").keyup(function(){\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tvar wordLength = $(this).val().length; // 검색어의 길이 알아오기\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(wordLength == 0) {\r\n");
      out.write("\t\t\t\t$(\"#displayList\").hide();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\telse {\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\turl:\"");
      ...
      out.write("\t\t\t\t\t\t/* ▲ getParameter해옴\t▲ id의 value값 */\r\n");
      ...
      out.write("\t\t\t\t\t\t\t// 검색된 데이터가 있는 경우\r\n");
      out.write("\t\t\t\t\t\t\tvar html = \"\";\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t$.each(json, function(entryIndex, item){\r\n");
      out.write("\t\t\t\t\t\t\t\tvar word = item.word;\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\tvar index = word.toLowerCase().indexOf($(\"#searchWord\").val().toLowerCase());\r\n");
      out.write("\t\t\t\t\t\t\t\t/* \t\t\t글자.다 소문자로 바꿔주기.몇번째 위치하는지 알아오기(찾고자하는 글자) */\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t//\tconsole.log(\"index:\" + index); // 검색어와 연관된 자동글 인덱스 값 콘솔창에 찍어보기\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\tvar len = $(\"#searchWord\").val().length;\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\tvar result = \"\";\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t//\tconsole.log(word.substr(0, index)); // 연관된 글 검색어 앞까지의 문장 찍어보기\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t//\tconsole.log(word.substr(index)); // 입력한 단어부터 끝까지\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t//\tconsole.log(word.substr(index, len)); // 내가 쓴 글씨만 찍기\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t//\tconsole.log(word.substr(index+len)); // 검색어 뒤부터 끝까지 찍기\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t    result += \"<span style='color:blue;'>\"+word.substr(0,index)+\"</span><span style='color:red;'>\"+word.substr(index,len)+\"</span><span style='color:blue;'>\"+word.substr(index+len)+\"</span>\"; \r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t    html += \"<span style='cursor:pointer;' class='result'>\"+result+\"</span><br/>\"; // 다음줄로\r\n");
      out.write("\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#displayList\").html(html); // 보여주기\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#displayList\").show(); // 검색어가 있을때만 관련 검색어 창 보여줌\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\telse {\r\n");
      out.write("\t\t\t\t\t\t\t// 검색된 데이터가 없는 경우\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#displayList\").hide();\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t},\r\n");
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t/* \r\n");
      out.write("\t\t\t\t\thttp://localhost:9090/board/wordSearchShow.action?searchType=name&searchWord='지'\r\n");
      out.write("\t\t\t\t\t이 경로로 들어가면 [{\"word\":\"무지개\"},{\"word\":\"지원지원\"}] 가 나오는걸 확인할 수 있음\r\n");
      out.write("\t\t\t\t\t */\t\t\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}); // end of $(\"#searchWord\").keyup(function(){})--------------\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t");
      out.write("\r\n");
      out.write("\t\t$(document).on(\"click\", \".result\", function(){\r\n");
      out.write("\t\t\tvar word = $(this).text(); // 여러개 관련 검색어 중 하나 선택하면 그 문장만 잡아옴\r\n");
      out.write("\t\t//\talert(word); \r\n");
      out.write("\t\t\t$(\"#searchWord\").val(word); // 관련 검색어 선택하면 검색창에 올라오게함\r\n");
      out.write("\t\t\t$(\"#displayList\").hide(); // 그리고 남은 관련 검색어들 숨김\r\n");
      out.write("\t\t\tgoSearch();\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t// === #122.\r\n");
      out.write("\t\t// 페이징 처리되어진 후 특정글제목을 클릭하여 상세내용을 본 이후\r\n");
      ...
      out.write("\t\tfrm.action = \"view.action\";\r\n");
      ...
      out.write("\t\t\t");
      out.write("\r\n");
      out.write("\t\t\t<th style=\"width: 70px;  text-align: center;\">첨부파일</th>\r\n");
      out.write("\t\t</tr>\t\r\n");
      out.write("\t\t");
      //  c:forEach
      ...
      try {
        ...
        // /WEB-INF/views/tiles1/board/list.jsp(180,2) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_c_005fforEach_005f0.setVar("boardvo");
        // /WEB-INF/views/tiles1/board/list.jsp(180,2) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
        _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/tiles1/board/list.jsp(180,2) '${boardList}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${boardList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
        // /WEB-INF/views/tiles1/board/list.jsp(180,2) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          ...
          if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              try {
                ...
                // /WEB-INF/views/tiles1/board/list.jsp(230,5) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                _jspx_th_c_005fif_005f6.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${not empty boardvo.fileName}", boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
      ...
      out.write("\t");
      out.write("\r\n");
      out.write("\t<div align=\"center\" style=\"width: 70%; margin: 10px auto;\">\r\n");
      out.write("\t\t");
      ...
      out.write("\t");
      out.write("\r\n");
      out.write("\t<div id=\"displayList\" style=\"border: solid 1px gray; width: 318px; height: 100px; margin-left: 70px; margin-top: -1px; overflow: auto;\">\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\t");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/tiles1/board/list.jsp(204,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/tiles1/board/list.jsp(205,5) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/tiles1/board/list.jsp(208,5) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/tiles1/board/list.jsp(213,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f3, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/tiles1/board/list.jsp(214,5) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_c_005fif_005f4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t\t\t\t\t<span class=\"subject\" onclick=\"goView('");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${boardvo.seq}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("')\"><span style=\"color: red; font-weight: bold; padding-left: ");
  ...
  private boolean _jspx_meth_c_005fif_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f3, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/tiles1/board/list.jsp(217,5) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
